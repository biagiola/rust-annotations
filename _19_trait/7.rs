// Lecture: Traits Bound to conditionally implements methods
...
fn main() {
    ...
    println!("{}", hotel2.summarize()); // this implement display trait too

    let hotel3 = Hotel::new(vec!["The Sweet Escape", "Hilton Edition"]);
    // println!("{}", hotel3.summarize()); // this doesn't work, summarize exists but cannot be used
}
