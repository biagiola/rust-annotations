// Same example as the previous one but this file implements the display trait for each of our enums.
...
//
// Also, the write! macro is coming from std::fmt. It is not part of the Rust prelude.
use std::fmt;
